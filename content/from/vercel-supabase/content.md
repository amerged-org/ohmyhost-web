...
- **Preview deployments are not environments.** Vercel gives every branch a URL; here you get two named deployment environments, Dev and Prod, with environment-scoped secrets. Database data is shared or isolated according to the mode you choose. Dev is protected by default and answers 404 to anonymous requests until someone opens its share link; you can choose public Dev instead when you create the project.
