...
- **Preview deployments are not environments.** Vercel gives every branch a URL; here you get two named environments, Dev and Prod, each with its own data and secrets. Dev is private and answers 404 to anonymous requests until a ten-minute access ticket is redeemed.
