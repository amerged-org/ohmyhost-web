...
- Mail: {{ rate mail.sent }}. To, CC and BCC each count. Sending needs Paid and a verified sender subdomain; the sender zone uses about {{ credits unit.mailSenderZoneMonth }} a month.
