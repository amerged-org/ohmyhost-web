...
export const CREDIT_RATES = {
  ...
  "neon.branches": {
    quantity: 1,
    unit: "branch-month (744 h)",
    credits: "492.857143",
  },
  "r2.storage.standard": {
    quantity: 1,
    unit: "GB for 30 days (daily peak)",
    credits: "4.928571",
  },
  "r2.class_a": {
    quantity: 1000000,
  ...
  "ses.{region}.recipients (a-la-carte)": {
    quantity: 1000,
    unit: "recipients",
    credits: "34.5",
  },
  "ses.{region}.recipients (Essentials)": {
    quantity: 1000,
    unit: "recipients",
    credits: "52.571429",
  },
  "wfp.script": {
    quantity: 1,
    unit: "deployed script for a 744-hour month",
    credits: "6.571429",
  },
  ...
  "route53.zone": {
    quantity: 1,
    unit: "mail sender zone for a calendar month",
    credits: "164.285714",
  },
} as const;
