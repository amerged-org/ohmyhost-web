...
export const page: ContentPage = {
  path: "/blog/introducing-ohmyho-st",
  title: "Introducing the ohmyho.st beta: deploy with your agent",
  description:
    "The beta is open: bring a GitHub app, ask your coding agent to deploy it, share one credit balance across projects and ask the agent for usage and status.",
  kind: "article",
  published: "2026-09-13",
  modified: "2026-09-13",
  parent: "/blog",
  crumb: "Introducing the beta",
  markdown: `# Introducing the ohmyho.st beta
...
[Start with your agent](https://docs.ohmyho.st/quickstart) · [Explore the Skills](https://docs.ohmyho.st/skills) · [Home](/)`,
};
