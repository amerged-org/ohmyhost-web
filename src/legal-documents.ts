...
amerged B.V., Netherlands, operates ohmyho.st. We are the controller for personal data used to operate our website, manage accounts, answer enquiries, administer billing and protect the service. Use our [contact form](/contact) for all privacy questions and requests to exercise your rights.
...
Annex II to the ohmyho.st DPA. Version: September 13, 2026.
...
API-token creation exposes the new value once through the supported flow. Local persistence applies owner-only file controls. Short-lived handoffs and download capabilities have bounded lifetimes and remain subject to their scope. These controls do not make service execution end-to-end encrypted against every infrastructure operator.
...
Deletion follows scoped operation records and provider observations. Retained backups are restricted and expire under their applicable lifecycle. Website beta-interest and contact records have explicit expiry timestamps and are purged through the existing maintenance process. Legal or data-subject requests are handled through the contact channel and recorded with access limited to responsible personnel.
