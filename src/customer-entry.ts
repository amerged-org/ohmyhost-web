...
import { SITE_CSS, BETA_SCRIPT, PRIVACY_UI, FIGURE_SCRIPT } from "./generated-site-frame.js";
...
export const CLIENT_RELEASE = "0.1.8";
export const RETAINED_CLIENT_RELEASES = [CLIENT_RELEASE, "0.1.7", "0.1.6", "0.1.5"] as const;
